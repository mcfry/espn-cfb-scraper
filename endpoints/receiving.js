...
// ----------
// RECEIVING
// name, position, receptions, yards, avg, long, tds
// ----------
...
chromium.launch({ headless: true }).then(async browser => {
  ...
  console.log("Fetching espn receiving page, sorted yards desc")
  await page.goto(
    "https://www.espn.com/college-football/stats/player/_/stat/receiving/season/2022/table/receiving/sort/receivingYards/dir/desc",
    { waitUntil: "load" }
  )
  console.log("Done")
